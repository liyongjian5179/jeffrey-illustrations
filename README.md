...
| --- | --- |
| ![Jeffrey Original two breakpoints](./assets/examples/original/01-two-breakpoints.png) | ![Jeffrey Q two breakpoints](./assets/examples/q/01-two-breakpoints.png) |

### 02 Minimum Loop

| Jeffrey Original | Jeffrey Q |
| --- | --- |
| ![Jeffrey Original minimum loop](./assets/examples/original/02-minimum-loop.png) | ![Jeffrey Q minimum loop](./assets/examples/q/02-minimum-loop.png) |

### 03 Sort By Purpose

| Jeffrey Original | Jeffrey Q |
| --- | --- |
| ![Jeffrey Original sort by purpose](./assets/examples/original/03-sort-by-purpose.png) | ![Jeffrey Q sort by purpose](./assets/examples/q/03-sort-by-purpose.png) |

### 04 One Idea, Many Outputs

| Jeffrey Original | Jeffrey Q |
| --- | --- |
| ![Jeffrey Original one idea many outputs](./assets/examples/original/04-one-fish-many-uses.png) | ![Jeffrey Q one idea many outputs](./assets/examples/q/04-one-fish-many-uses.png) |

### 05 Handoff Path

| Jeffrey Original | Jeffrey Q |
| --- | --- |
| ![Jeffrey Original handoff path](./assets/examples/original/05-handoff-path.png) | ![Jeffrey Q handoff path](./assets/examples/q/05-handoff-path.png) |

### 06 Three Sources

| Jeffrey Original | Jeffrey Q |
| --- | --- |
| ![Jeffrey Original three sources](./assets/examples/original/06-three-sources.png) | ![Jeffrey Q three sources](./assets/examples/q/06-three-sources.png) |

### 07 Three Content Jobs

| Jeffrey Original | Jeffrey Q |
| --- | --- |
| ![Jeffrey Original three content jobs](./assets/examples/original/07-three-content-jobs.png) | ![Jeffrey Q three content jobs](./assets/examples/q/07-three-content-jobs.png) |

### 08 Handoff Copy Toolbox

| Jeffrey Original | Jeffrey Q |
| --- | --- |
| ![Jeffrey Original handoff copy toolbox](./assets/examples/original/08-handoff-copy-toolbox.png) | ![Jeffrey Q handoff copy toolbox](./assets/examples/q/08-handoff-copy-toolbox.png) |

### 09 Common Pits

| Jeffrey Original | Jeffrey Q |
| --- | --- |
| ![Jeffrey Original common pits](./assets/examples/original/09-common-pits-no-title.png) | ![Jeffrey Q common pits](./assets/examples/q/09-common-pits-no-title.png) |

### 10 Information Well

| Jeffrey Original | Jeffrey Q |
| --- | --- |
| ![Jeffrey Original information well](./assets/examples/original/10-information-well.png) | ![Jeffrey Q information well](./assets/examples/q/10-information-well.png) |

### 11 Idea Press

| Jeffrey Original | Jeffrey Q |
| --- | --- |
| ![Jeffrey Original idea press](./assets/examples/original/11-idea-press.png) | ![Jeffrey Q idea press](./assets/examples/q/11-idea-press.png) |

### 12 Content Fermentation

| Jeffrey Original | Jeffrey Q |
| --- | --- |
| ![Jeffrey Original content fermentation](./assets/examples/original/12-content-fermentation.png) | ![Jeffrey Q content fermentation](./assets/examples/q/12-content-fermentation.png) |

### 13 System Bearing

| Jeffrey Original | Jeffrey Q |
| --- | --- |
| ![Jeffrey Original system bearing](./assets/examples/original/13-system-bearing.png) | ![Jeffrey Q system bearing](./assets/examples/q/13-system-bearing.png) |

### 14 Trust Bridge

| Jeffrey Original | Jeffrey Q |
| --- | --- |
| ![Jeffrey Original trust bridge](./assets/examples/original/14-trust-bridge.png) | ![Jeffrey Q trust bridge](./assets/examples/q/14-trust-bridge.png) |
...
- 清爽短发：**Jeffrey Hair™ = 短碎盖为主，轻微自然偏向；圆、短、碎，不要明显四六分**
- 无胡子、无八字胡、无络腮胡
- 圆框眼镜
- 深蓝色头戴式耳机，黄色内圈
